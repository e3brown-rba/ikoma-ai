...
def update_repo_structure():
        ...
        for script_file in script_files:
            ...
            if script_file.name == "bulk_create_phase2.py":
                script_entry = {
                    ...
                    "features": ["automated_setup", "data_generation", "phase_2_preparation"],
                    "last_updated": "current_structure_update"
                }
                ...
                script_entry = {
                    ...
                    "sections": ["script_overview", "usage_instructions", "phase_2_preparation"],
                    "last_updated": "current_structure_update"
                }
            else:
    ...
    current_structure_entry = {
        ...
        "total_lines": sum(count_lines_safe(f) for f in Path(".").rglob("*.py") if f.is_file()),
    ...
    with open(repo_structure_file, 'w') as f:
        for entry in existing_entries:
            if entry.get('type') != 'current_structure':  # Skip old current_structure entries
