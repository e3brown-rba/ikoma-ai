...
class TestPerformanceResult:
    ...
    def test_to_dict(self):
        ...
        result = PerformanceResult(name="test_metric", value=1.234, unit="seconds")
...
class TestBenchmarkMetrics:
    ...
    def test_save_artifacts(self, tmp_path):
        ...
        metrics = BenchmarkMetrics()
        results = [PerformanceResult("test_metric", 1.5)]
...
class TestIkomaBenchmark:
    ...
    def test_save_baseline(self, tmp_path):
        ...
        results = [PerformanceResult("metric1", 1.0), PerformanceResult("metric2", 2.0)]
